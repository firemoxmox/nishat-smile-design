    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-14">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-display text-foreground mb-4">
          Find Us in <span className="text-primary">Darbhanga</span>
        </h2>
      ...
      <div className="grid md:grid-cols-5 gap-6">
        {/* Map */}
        <div className="md:col-span-3 rounded-xl overflow-hidden shadow-lg border border-border/50 min-h-[350px]">
          <iframe
