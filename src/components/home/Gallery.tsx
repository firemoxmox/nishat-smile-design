...
const images = [
  { src: modernClinic, alt: "Modern dental clinic", span: "col-span-2 row-span-2" },
  { src: clinic1, alt: "Dr. Kamil Shahnawaz", span: "" },
  { src: dentalCare, alt: "Dental care in progress", span: "" },
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-14">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold font-display text-foreground mb-4">
          Inside <span className="text-gradient">Nishat Dental</span>
        </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        {images.map((img) => (
          <div key={img.alt} className={`${img.span} rounded-2xl overflow-hidden group cursor-pointer`}>
            <img
              src={img.src}
              alt={img.alt}
